...
class HomePage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        ...
        this.sexArray = { "id": 16777229, "type": 10009, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" };
    ...
    aboutToAppear() {
        ...
        manager.getStringValue({ "id": 16777235, "type": 10003, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" }.id, (error, sexValue) => {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.backgroundColor({ "id": 16777218, "type": 10001, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777248, "type": 20000, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" });
            Image.debugLine("pages/HomePage.ets(71:7)");
            Image.width({ "id": 16777265, "type": 10002, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" });
            Image.height({ "id": 16777265, "type": 10002, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777245, "type": 20000, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" });
            Image.debugLine("pages/HomePage.ets(83:7)");
            Image.width({ "id": 16777252, "type": 10002, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" });
            Image.height({ "id": 16777252, "type": 10002, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 16777240, "type": 10003, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" });
            Text.debugLine("pages/HomePage.ets(88:7)");
            Text.fontColor(Color.Black);
            Text.fontSize({ "id": 16777283, "type": 10002, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" });
            ...
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ...
                if (isInitialRender) {
                    ViewPU.create(new TextInputWidget(this, {
                        inputImage: { "id": 16777226, "type": 20000, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" },
                        hintText: { "id": 16777238, "type": 10003, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" }
                    }, undefined, elmtId));
                }
                else {
            ...
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ...
                if (isInitialRender) {
                    ViewPU.create(new TextCommonWidget(this, {
                        textImage: { "id": 16777295, "type": 20000, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" },
                        title: { "id": 16777242, "type": 10003, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" },
        ...
        }
        {
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ...
                if (isInitialRender) {
                    ViewPU.create(new TextCommonWidget(this, {
                        textImage: { "id": 16777247, "type": 20000, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" },
                        title: { "id": 16777244, "type": 10003, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" },
                        content: this.__sex,
                        onItemClick: () => {
        ...
        }
        {
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ...
                if (isInitialRender) {
                    ViewPU.create(new TextInputWidget(this, {
                        inputImage: { "id": 16777230, "type": 20000, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" },
                        hintText: { "id": 16777239, "type": 10003, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" }
                    }, undefined, elmtId));
                }
                else {
                    this.updateStateVarsOfChildByElmtId(elmtId, {});
        ...
        }
        {
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ...
                if (isInitialRender) {
                    ViewPU.create(new TextCommonWidget(this, {
                        textImage: { "id": 16777225, "type": 20000, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" },
                        title: { "id": 16777243, "type": 10003, params: [], "bundleName": "com.huawei.multipledialog", "moduleName": "entry" },
